...
<div class="item">
    <div class="content " style="background-image: url('{{ asset('storage/images/website_images/'.$item->image) }}');">

        <div class="info">
            <div class=" " style="font-size: 40px"> {{Config::get('app.locale') == 'ar' ? $item->desc_ar :    $item->desc_en}} </div>
            <a class="btn-outline btn-slider" href="#">{{Config::get('app.locale') == 'ar' ? 'ابدأ الان' : 'Start Now' }}</a>
        </div>
