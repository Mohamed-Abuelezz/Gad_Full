        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form class="row g-3" action="{{   url('admin/addPackages') }}" method="post">
                        @csrf
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <input type="text" class="form-control  {{$errors->has('take_long') ? 'is-invalid' :  '' }}" id="inputPassword2" placeholder="المدة " name='take_long' value="{{ old('take_long')}}">
                        ...
                        <div class="col-auto">
                            <input type="text" class="form-control  {{$errors->has('price') ? 'is-invalid' :  '' }}" id="inputPassword2" placeholder="السعر " name='price' value="{{ old('price')}}">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>{{$package->take_long}} يوم</td>
                                    <td>{{$package->price}} </td>
                                    <td>
                                        <a class="btn btn-danger" href="{{url('admin/deleteCountry/'.$package->id)}}" role="button">حذف</a>
                                    </td>
