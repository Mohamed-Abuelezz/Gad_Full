        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <form class="row g-3" action="{{   url('admin/addprofileType') }}" method="post">
                        @csrf
                        <div class="col-auto">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>{{$profile_Type->name_ar}}</td>
                                    <td>
                                        <a class="btn btn-danger" href="{{url('admin/deleteProfileType/'.$profile_Type->id)}}" role="button">حذف</a>
                                    </td>
