...
<form action="{{URL::to('admin/add_subscribersType')}}" method="POST" enctype="multipart/form-data">
  @csrf
...
<br>
  ...
  @foreach ($subscribersType as $subscribeType)
                                         <tr>
                                          <td>{{$subscribeType->id}}</td>
                                            <td>{{$subscribeType->title_ar}}</td>
                                            <td><a href="{{URL::to('admin/subscribersType/delete_subscribersType')}}?subscribersType_id={{$subscribeType->id}}" class="btn btn-danger" >Delete</a></td>
                                        </tr>
