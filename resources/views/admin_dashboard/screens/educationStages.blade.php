...
<form action="{{URL::to('admin/add_educationStage')}}" method="POST" enctype="multipart/form-data">
  @csrf
...
<input type="submit" class="btn btn-primary"/>
  ...
  @foreach ($educationsStages as $educationsStage)
                                         <tr>
                                          <td>{{$educationsStage->id}}</td>
                                            <td>{{$educationsStage->title_ar}}</td>
                                            <td>{{$educationsStage->countries->name_ar}}</td>
                                            <td><a href="{{URL::to('admin/educationStages/delete_educationStage')}}?educationsStage_id={{$educationsStage->id}}" class="btn btn-danger" >Delete</a></td>
                                        </tr>
